...
import { CreditCard, Menu, RefreshCw, LogOut, DollarSign, TrendingUp } from "lucide-react"
        ...
        <div className="container mx-auto p-6 space-y-8">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 p-6 rounded-2xl bg-gradient-to-r from-white/80 to-blue-50/80 backdrop-blur-sm border border-white/20 shadow-xl">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-lg text-gray-600 font-medium">Manage subscription payments</p>
              </div>
            </div>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <Card className="border-0 shadow-xl bg-gradient-to-br from-white to-blue-50 backdrop-blur-sm hover:shadow-2xl transition-all duration-500">
              ...
              <CardContent>
                ...
                <p className="text-xs text-gray-600">From 0 payments</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-xl bg-gradient-to-br from-white to-green-50 backdrop-blur-sm hover:shadow-2xl transition-all duration-500">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
                <CardTitle className="text-sm font-semibold text-gray-700">Active Payments</CardTitle>
          ...
          <Card className="border-0 shadow-xl bg-gradient-to-br from-white to-green-50/50 backdrop-blur-sm">
            ...
            <CardContent className="text-center py-12">
              ...
              <p className="text-gray-400 text-sm mt-2">Payments will appear here when data is available</p>
            </CardContent>
          </Card>
        </div>
      </div>
